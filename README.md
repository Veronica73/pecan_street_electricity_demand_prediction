...
# Dataset
The data for this project is individual users' daily energy consumption from Pecan Street. You could download the data [here](https://www.kaggle.com/datasets/zhitingzheng/pecan-street-electricity-data). You could learn more about Pecen Street from [here](https://www.pecanstreet.org/). 
